...
| 6 | App-Icon (1024x1024) und Splash | Claude | ERLEDIGT (2026-08-12): Neu gezeichnet als Vektorgrafik, Quellen in `assets/source/*.svg`, Bau ueber `npm run build:icons`. Motiv: zweifarbige Kapsel in den Marken-Tokens (Petrol #1c4f5c auf Papier #f6f3ed), textfrei, randlos, ohne eigene Rundung. Die drei Maengel des Entwurfs sind weg: kein Schriftzug (der zudem als "MvSuplea" renderte), keine Doppel-Rundung, Motiv nicht mehr im Android-Beschnitt. Geprueft bei 1024/120/40 px sowie unter iOS-Squircle, Android-Kreis und Android-Squircle. icon/splash/favicon ohne Alpha-Kanal (Apple-Vorgabe), adaptive-icon mit Transparenz und innerhalb der 66-Prozent-Safe-Zone. `backgroundColor` in app.json von #011530 auf den Akzent-Token gezogen |

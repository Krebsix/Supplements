...
export default {
  ...
  'account.field.showPassword': 'Show password',
  'account.field.hidePassword': 'Hide password',
  ...
  'account.cloud.unreadableDataText': 'The backup from {time} on {device} cannot be opened with this app version. Both sets of data are kept. Check whether a newer app version is available. Replacing permanently overwrites the existing backup with this device’s data.',
  'account.cloud.keepBackup': 'Keep backup',
  'account.cloud.blocked': 'The existing backup remains protected. Automatic and manual backups are blocked. Reopen the app to check the backup and make an explicit choice.',

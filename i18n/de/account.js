...
export default {
  ...
  'account.cloud.unreadableDataText': 'Der Stand vom {time} von {device} kann mit dieser App-Version nicht geöffnet werden. Beide Datenstände bleiben erhalten. Prüfe, ob eine neuere App-Version verfügbar ist. Dauerhaft ersetzen überschreibt das vorhandene Backup mit den Daten dieses Geräts.',
  'account.cloud.keepBackup': 'Backup behalten',
  'account.cloud.blocked': 'Das vorhandene Backup bleibt geschützt. Automatisches und manuelles Sichern sind gesperrt. Öffne die App erneut, um den Stand zu prüfen und bewusst zu entscheiden.',

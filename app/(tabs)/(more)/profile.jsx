...
const styles = StyleSheet.create({
  ...
  privacyTitle: { color: colors.accent, fontSize: 13, fontWeight: '700', marginBottom: space.xs },
  ...
  findingSeverity: { fontSize: 11, fontWeight: '700', textAlign: 'right', flexShrink: 0, maxWidth: 130 },

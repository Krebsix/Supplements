      ...
      {supplements.length === 0 ? (
        ...
        <View style={styles.card}>
          ...
          <View style={styles.chipWrap}>
            {supplements.map((supplement) => (
              <TouchableOpacity
                ...
                accessibilityState={{ selected: draftSupplement?.id === supplement.id }}
              >
          ...
          <View style={styles.chipWrap}>
            {OUTCOME_METRICS.map((metric) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                accessibilityRole="button"
                accessibilityState={{ selected: draftMetric === metric.id }}
              >
          ...
          <TextInput
            ...
            accessibilityLabel={t('outcome.new.reason')}
          />
          ...
          <View style={styles.chipWrap}>
            {TRIAL_DURATIONS.map((days) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                accessibilityRole="button"
                accessibilityState={{ selected: draftDuration === days }}
              >
...
const styles = StyleSheet.create({
  ...
  dueBadge: { color: colors.caution, fontSize: 11, fontWeight: '700' },
  ...
  blockTitle: { color: colors.ink, fontSize: 13, fontWeight: '700', marginBottom: 5 },
  resultBlock: {
  ...
  dueButtonText: { color: colors.ink, fontSize: 12, fontWeight: '700' },
  finishedCard: { ...surfaces.card, padding: space.md, marginBottom: space.sm + 2 },
  finishedName: { color: colors.ink, fontSize: 14, fontWeight: '700' },
